      ...
      <footer>
        <div className="footer-div">
          <img
            ...
            alt="not found"
          />
          <p style={{ color: "white", marginBottom: "0px", marginTop: "10px" }}>
            © 2023 KRAFTON, Inc. All rights reserved.
          </p>
          <ul>
            <a href="https://www.battlegroundsmobileindia.com/privacy">
              <li>Privacy Policy |</li>
            </a>
            <a href="https://www.battlegroundsmobileindia.com/terms">
              <li>Terms of Service |</li>
            </a>
            <a href="https://www.battlegroundsmobileindia.com/rules">
              <li>Rules of Conduct |</li>
            </a>
            <a href="https://www.battlegroundsmobileindia.com/privacy_community">
              <li>Official Community Policy |</li>
            </a>
            <a href="https://www.battlegroundsmobileindia.com/ccg">
              <li>Content Creation Guideline |</li>
            </a>
          </ul>
        </div>
      </footer>
